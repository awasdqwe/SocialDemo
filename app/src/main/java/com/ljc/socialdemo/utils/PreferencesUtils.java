 ...
 * <li>put Object {@link #saveBeanByFastJson(Context, String, Object)}</li>
...
public class PreferencesUtils {
    ...
    // 保存bean对象
    public static boolean saveBeanByFastJson(Context context,String key,Object obj){
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        String toJson = new Gson().toJson(obj);
        return editor.putString(key,toJson).commit();
    }

    // 提取bean对象
    public static <T> T getBeanByFastJson(Context context,String key, String defaultValue,Class<T> clazz){
        String string = getString(context, key,defaultValue);
